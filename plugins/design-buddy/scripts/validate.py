...
design-buddy is a multi-tool plugin (Claude Code + Cursor + Codex): one shared skills/agents tree
with a manifest for each tool. Python 3 stdlib only (plugin script policy: Python, never Bash). Checks:
